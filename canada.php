...
<main class="main">
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                    <h1 class="mb-3">Find the best Instituition in CANADA</h1>
    ...
    <!-- Clients Section -->
    <?php include "./pages/component/canada/canada_clint_section.php"; ?>
    <!-- /Clients Section -->

    <!-- simple icon section -->
    <section>
        <div class="container">
            <h1 class="text-center fw-semibold">Why Study In CANADA</h1>
            <div class="row mt-5">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center align-items-center">
                    <div class="p-3">
                        <h1 class="fw-semibold">How to Apply for CANADA</h1>
  ...
  <?php include "./pages/component/canada/canada_university_details.php"; ?>
  <!-- /university Detaiils Section -->
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center align-items-center">
                    <div class="p-3">
                        <h5 class="my-4 text-primary">AWorried about job security in the competetive CANADA job market?
                        </h5>
                        <h1 class="fw-semibold">CANADA has some of the <br> best job opportunities <br> for students</h1>
