...
<main class="main">
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                    <h1 class="mb-3">Find the best Instituition in AUSTRALIA</h1>
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="assets/src_gsc/image/l3/png/australia.png" class="img-fluid animated rounded-3"
    ...
    <!-- Clients Section -->
    <?php include "./pages/component/australia/australia_clint_section.php"; ?>
    <!-- /Clients Section -->

    <!-- simple icon section -->
    <section>
        <div class="container">
            <h1 class="text-center fw-semibold">Why Study In AUSTRALIA</h1>
            <div class="row mt-5">
                ...
                <div class="col-md-3 d-flex flex-column justify-content-center align-items-center p-2 ">
                    <div class="card" style="min-height: 300px;">
                        <div class="card-body">
                            ...
                            <h5 class="mt-4 mb-2 fw-semibold">More than 250 Universities</h5>
                            <p class="text-muted blockquote mt-4">250+ Courses to Choose from</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card" style="min-height: 300px;">
                        <div class="card-body">
                            <div class="rounded-3 d-flex justify-content-center p-2"
                                ...
                                <img src="assets/src_gsc/image/l1/png/canada-icon-4.png" alt="">
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center align-items-center">
                    <div class="p-3">
                        <h1 class="fw-semibold">How to Apply for AUSTRALIA</h1>
  ...
  <?php include "./pages/component/australia/australia_university_details.php"; ?>
  <!-- /university Detaiils Section -->
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center align-items-center">
                    <div class="p-3">
                        <h5 class="my-4 text-primary">AWorried about job security in the competetive AUSTRALIA job market?
                        </h5>
                        <h1 class="fw-semibold">AUSTRALIA has some of the <br> best job opportunities <br> for students</h1>
