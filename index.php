    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
          ...
          <p>For over 30 years, Global Study Contacts (part of Contacts International) has been the ‘home’ of overseas
    ...
    <div class="container" data-aos="zoom-in">
      ...
      <div class="row p-4">
        <div class="single-brand-logo aos-init aos-animate col-12 col-md-2 col-lg-2 rounded-3 p-4">
          <img src="assets/src_gsc/image/l1/png/uk-uni-1.jpg" class="img-fluid rounded-3" alt="">
        </div>
        <div class="single-brand-logo aos-init aos-animate col-12 col-md-2 col-lg-2 rounded-3 p-4">
          <img src="assets/src_gsc/image/l1/png/uk-uni-2.jpg" class="img-fluid rounded-3" alt="">
        </div>
        <div class="single-brand-logo aos-init aos-animate col-12 col-md-2 col-lg-2 rounded-3 p-4">
          <img src="assets/src_gsc/image/l1/png/uk-uni-1.jpg" class="img-fluid rounded-3" alt="">
        </div>
        ...
        <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
          <div class="service-item position-relative rounded-3">
            <a href="https://gsc.co.com/apply-agent/portal/index.php">
              ...
              <h4 class="text-center"><span class="stretched-link">Institutes</span></h4>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
          ...
          <div class="faq-container px-xl-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="faq-item">
              ...
              <div class="faq-content">
                <p>Our philosophy is that the student comes first. Our counselors work hard to ensure that they help
        ...
        <div class="col-lg-5 order-1 order-lg-2 why-us-img">
          <img src="./assets/img/why-us.png" class="img-fluid rounded-3" alt="" data-aos="zoom-in" data-aos-delay="100">
        </div>
      </div>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="card h-100%">
            <div class="card-body">
              <img src="assets/src_gsc/image/l1/png/uk-uni-4.jpg" class="img-fluid rounded-3" alt=""
        ...
        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="card h-100%">
            <div class="card-body">
              <img src="assets/src_gsc/image/l1/png/canada-logo-1.jpg" class="img-fluid rounded-3" alt=""
                style="width:100px;height: 100px;">

              <div class="pt-4">
                <h5 class="py-2">Trent University</h5>
                <span class="text-small bg-info py-1 px-2 rounded-2 text-white text-uppercase"
                  style="font-size: 10px;"><i class="bi bi-geo-alt-fill mr-2 "></i> CANADA</span>
        ...
        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="card h-100%">
            <div class="card-body">
              <img src="assets/src_gsc/image/l1/png/australia-logo-1.jpg" class="img-fluid rounded-3" alt=""
                style="width:100px;height: 100px;">
      ...
      <div class="row gy-4 mt-4">
        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="card h-100%">
            <div class="card-body">
              <img src="assets/src_gsc/image/l1/png/usa-logo-1.jpg" class="img-fluid rounded-3" alt=""
                style="width:100px;height: 100px;">
        ...
        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="card h-100%">
            <div class="card-body">
              <img src="assets/src_gsc/image/l1/png/uk-uni-3.jpg" class="img-fluid rounded-3" alt=""
                style="width:100px;height: 100px;">
        ...
        <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="card h-100%">
            <div class="card-body">
              <img src="assets/src_gsc/image/l1/png/east-china-uni.jpg" class="img-fluid rounded-3" alt=""
                style="width:100px;height: 100px;">

              <div class="pt-4">
                <h5 class="py-2">East China University of Science & Technology</h5>
                <span class="text-small bg-info py-1 px-2 rounded-2 text-white text-uppercase"
                  style="font-size: 10px;"><i class="bi bi-geo-alt-fill mr-2"></i> chaina</span>
