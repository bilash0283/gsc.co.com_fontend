  ...
  <div class="container">
    <div class="row justify-content-center text-center">
      ...
      <div class="col-lg-6">
          ...
          <button class=" border-none text-white fw-semibold reg_btn_hover p-2 m-3"><a href="https://gsc.co.com/apply-agent/portal/index.php" class="text-white">REGISTATION</a></button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row gy-4">
    <div class="col-lg-4 col-md-6 footer-about">
      <a href="index.php" class="d-flex align-items-center">
        <img src="./assets/src_gsc/favicon2.png" alt="" class="img-fluid" style="width:120px;height: 120px;">
      </a>
